...
if &t_Co > 255
   ...
   hi Directory       ctermfg=149               cterm=bold
   hi Error           ctermfg=219 ctermbg=89
   hi ErrorMsg        ctermfg=199 ctermbg=16    cterm=bold
   hi Exception       ctermfg=149               cterm=bold
   ...
   " complete menu
   hi Pmenu           ctermfg=117  ctermbg=16
   ...
   " marks column
   hi SignColumn      ctermfg=149 ctermbg=235
   hi SpecialChar     ctermfg=168               cterm=bold
   hi SpecialComment  ctermfg=245               cterm=bold
   hi Special         ctermfg=117  ctermbg=232
   ...
   hi NonText         ctermfg=108
   hi SpecialKey      ctermfg=108
end
